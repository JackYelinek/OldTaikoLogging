...
namespace Ranked_Logs
{
    class Screen_Grab_2
    {
        // This will be unused for this project, but I'm keeping it here for future reference
        ...
        private void Source_NewFrame(object sender, NewFrameEventArgs eventArgs)
        {
            ...
            frame.Save(string.Format(@"D:\My Stuff\My Programs\Taiko\Test Data\test{0}.png", i++.ToString()));
            int potato = 64;
        }
